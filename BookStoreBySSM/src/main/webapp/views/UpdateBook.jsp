	...
	<div data-options="region:'west',title:' '" style="width:180px;">	
		<div id="Vnavigation">
	    	<ul>
		    	...
		    	<li><p id="dealManager"><a href="DealManagerServlet">订单管理</a></p></li>
		    	<li><p id="dealManager"><a href="AnnouncementManagerServlet">公告管理</a></p></li>
		    	<li><p id="bookSaleInfos"><a href="BookSaleInfoServlet">商品销售信息</a></p></li>
		    </ul>
		</div>
	</div>
	 ...
	 <div data-options="region:'center'">
	 	<div class="title">
			<p style="width:220px;">修改商品</p>
		</div>
			<p id="returnHome"><a href="../views/Manager.jsp">返回首页</a></p>
			
		 <div id="updateBook">
		 	<form action="../bookController/updateBook" method="post">
			 	<p>序列号:<input type="text" name="bookId" value=<%= bookId %> readonly="readonly" style="width:810px;"/></p>
			 	...
			 	<p><input type="submit" class="btn" id="submit" value="修改" />
