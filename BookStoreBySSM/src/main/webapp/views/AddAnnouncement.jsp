	...
	<div data-options="region:'center'">
		...
		<div id="addAnnouncement">
		 	<form action="../announcementController/addAnnouncement" method="post">
			 	<p>公告编号:<input type="text" name="announcementId"  required="required" /></p>
			 	<p>公告标题:<input type="text" name="announcementTitle"  required="required" /></p>
			 	<p>公告内容:<input type="text" name="announcementContent"  required="required" /></p>
			 	<p>是否在首页显示:<input type="text" name="announcementShow"  required="required" style="width:680px;" placeholder="请输入true或false"/></p>
