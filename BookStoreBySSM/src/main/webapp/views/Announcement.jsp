...
<style type="text/css">
	...
	.announcement #announcementTilte{
		display:block;
		margin:0px auto;
		padding:10px;
		text-align: center;
...
<body class="easyui-layout">
		...
		%>
		    <div id="Vnavigation">
		    	<ul>
		    		...
		    		<li><p id="test"><a href="">链接1</a></p></li>
		    		<li><p id="test"><a href="">链接2</a></p></li>
		    		<li><p id="test"><a href="">链接3</a></p></li>
		    		<li><p id="test"><a href="">链接4</a></p></li>
		    	</ul>
		    </div>
		<%
		}else{
	...
	<div data-options="region:'center'">
	    ...
	    <div class="title">
			<p style="width:115px;">公告</p>
		</div>
			<p id="returnHome"><a href="../views/HomePage.jsp">返回首页</a></p>
			
			
	    <div class="announcement">
	    	<div id="announcementTilte">${announcement.announcementTitle}</div>
	    	<textarea>
