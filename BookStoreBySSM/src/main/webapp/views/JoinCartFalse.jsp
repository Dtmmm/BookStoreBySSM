...
<body class="easyui-layout">
		...
		%>
		    <div id="Vnavigation">
		    	<ul>
		    		...
		    		<li><p id="test"><a href="">链接1&crarr;</a></p></li>
		    		<li><p id="test"><a href="">链接2&crarr;</a></p></li>
		    		<li><p id="test"><a href="">链接3&crarr;</a></p></li>
		    		<li><p id="test"><a href="">链接4&crarr;</a></p></li>
		    	</ul>
		    </div>
		<%
		}else{
		...
		%>
		    <div id="Vnavigation">
		    	<ul>
		    		...
		    		<li><br></li>
		    		<li><p id="reLogin" ><a href="Login.jsp">重新登录</a></p></li>
		    		<li><p id="reLogin" ><a href="ExitServlet">退出登录</a></p></li>
		    		<li><p id="userCart"><a href="UserCartServlet?id=<%= id %>">我的购物车</a></p></li>
		    		<li><p id="test"><a href="UserInfoServlet?id=<%= id %>">我的信息</a></p></li>
		    		<li><p id="test"><a href="UserDealServlet?id=<%= id %>">我的订单</a></p></li>
		    	</ul>
		    </div>
		<%
		}
	...
	<div data-options="region:'center'">
	    ...
	    <div class="message">
			<div id="content">
				<p>加入购物车失败！<a href="../views/HomePage.jsp">返回商城首页</a></p>
		    </div>
	    </div>
    </div>
</body>
